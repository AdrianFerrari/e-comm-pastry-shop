  ...
  results: [
    {
      ...
      title: "Amandine",
      description:
        "Bizcocho en capas de chocolate relleno de chocolate, caramelo y crema fondant.",
      cost: 100,
    ...
    },
    {
      ...
      description:
        "Un tipo de bizcocho en capas, a menudo adornado con crema y colorante para alimentos.",
      cost: 140,
    ...
    },
    {
      ...
      description:
        "Un pastel con manzanas, ocasionalmente cubierto con glaseado de caramelo.",
      cost: 100,
    ...
    },
    {
      ...
      title: "Babka",
      description:
        "Un pastel dulce trenzado que se originó en las comunidades judías.",
      cost: 55,
    ...
    },
    {
      ...
      description:
        "Cualquier bizcocho preparado con cerveza como ingrediente principal; En la foto, un bizcocho de chocolate infundido con cerveza negra.",
      cost: 120,
    ...
    },
    {
      ...
      title: "Selva Negra",
      description:
        "Un pastel con cerezas, kirsch y chocolate. Por lo general, hay una capa inferior de masa quebrada de chocolate y dos capas de bizcocho de chocolate; Luego, el pastel se rellena con mermelada de cereza y crema batida.",
      cost: 200,
    ...
    },
    {
      ...
      title: "Chocotorta",
      description:
        "Un pastel hecho con galletas de chocolate, dulce de leche y queso crema.",
      cost: 105,
    ...
    },
    {
      ...
      title: "Coffe cake",
      description:
        "Un pastel de una sola capa con sabor a canela y cubierto con una cobertura de migas, destinado a comerse con café.",
      cost: 50,
    ...
    },
    {
      ...
      description:
        "Un rico bizcocho con frutas confitadas y especias; muchas versiones del pastel contienen grosellas, sultanas y cerezas glaseadas.",
      cost: 40,
      categories: ["fruta"],
      imgName: "Fruitcake",
      img: { fruta },
    },
    {
      ...
      title: "Torta Dundee",
      description:
        "Un pastel de frutas sin cerezas glaseadas cubierto con almendras.",
      cost: 80,
      categories: ["fruta"],
      imgName: "Dundee_cake",
      img: { dundee },
    },
    {
      ...
      title: "Funnelcake",
      description:
        "Una pasta choux con azúcar en polvo u otros aderezos, generalmente fruta.",
      cost: 98,
      categories: ["fruta"],
      imgName: "funnel_cake",
      img: { funnel },
    },
    {
      ...
      description:
        "Pastel preparado con frutas ciruelas como ingredientes principales.",
      cost: 65,
      categories: ["fruta"],
      imgName: "Plum_cake",
      img: { plum },
    },
    {
      ...
      description:
        "Un pastel de mantequilla de vainilla, café o chocolate en el que dos masas de diferentes colores se mezclan para mostrar un patrón similar al mármol.",
      cost: 100,
