    ...
    return (
        <main className='products'>
            <div className='sidebar'>
                <h2>Catergories</h2>
                <button onClick={filterProducts}  name="all">All</button>
                <button onClick={filterProducts}  name="chocolate">Chocolate</button>
                <button onClick={filterProducts}  name="vainilla">Vainilla</button>
                <button onClick={filterProducts}  name="manzana">Manzana</button>
                <button onClick={filterProducts}  name="fruta">Fruta</button>
                <button onClick={filterProducts}  name="cafe">Cafe</button>
            </div>
